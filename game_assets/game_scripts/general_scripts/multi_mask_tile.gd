...
export var loop_sprite:Array = [
	load("res://game_assets/game_sprites/levels_sprites/test_zone_assets/tileset/chr006.png"),
	load("res://game_assets/game_sprites/levels_sprites/test_zone_assets/tileset/chr007.png"),
	load("res://game_assets/game_sprites/levels_sprites/test_zone_assets/tileset/chr008.png")
]
